...
#include <iostream>
#include <fstream>
#include <matrix_inversion_project.h>
#define __CL_ENABLE_EXCEPTIONS



namespace matrix_inversion_project {
	std::vector<float> MatrixInversion::matrix_inversion(std::vector<float> matrix_vector, int matrix_order) {
