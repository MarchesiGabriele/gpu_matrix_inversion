...
"""
    file.write(f" {end1 - st1} {end2 - st2} {end3 - st3} {end4 - st4} {end5 - st5} {end6 - st6} {end7 - st7}  ")
...
if __name__ == "__main__":
    file = open("C:/TESI/TESI DOCUMENTAZIONE/BENCHMARKS/PYOPENCL_RAND_32.txt", "w")

    err = 0
    for h in range(REP):
        file.write(f"{h} ") 
        err += matrix_inv(file, h)
        file.write(f"{err} \n") 
